  ...
  return (
    ...
    <div>
          ...
          <form class="ui form" onSubmit={handleSubmit}>
            ...
            <input style={{marginTop: "20px"}} class="ui button" type="submit" value="Create New User" />
          ...
          <button class="ui button" style={{marginTop: "20px"}} onClick={handleLoginSignup}>Log In?</button>
    </div>         
    </div>
  )
}
